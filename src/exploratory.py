...
class LTVexploratory:
    ...
    def _validate_datasets(self) -> None:
        ...
        assert(is_datetime64_any_dtype(self.data_events[self.event_time_col])) , f"The column [{self.event_time_col}] referencing to the time in the events dataset was expected to be of type [datime]. But it is of type {self.data_events[self.event_time_col].dtype}"
